...
import os
import sys
from renogybt import InverterClient, RoverClient, RoverHistoryClient, BatteryClient, DataLogger, Utils, DccsClient
...
if config['device']['type'] == 'RNG_CTRL':
    ...
    DccsClient(config, on_data_received, on_error).start()
else:
